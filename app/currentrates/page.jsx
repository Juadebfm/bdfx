...
const OtherRates = () => {
  ...
  return (
    <section className="px-0 sm:px-20 mt-5 sm:mt-14 sm:mb-10 h-auto w-[100%]">
      <div className="mb-4">
        ...
        <table className="w-full mt-3">
            ...
            <tr>
              <th className="flex flex-col sm:flex-row items-center justify-center gap-0 sm:gap-5 mt-2 mb-4">
                <div className="flex flex-col items-center justify-center gap-0">
                  <span className="mt-0 sm:mt-2">NGN (By Dates)</span>
                </div>
              </th>
          ...
          <tbody>
            {getLast5Dates(apiData).map((date) => (
              ...
              >
                <td className="font-bold">{formatDate(date)}</td>
                {getUniqueCurrencyNames(apiData).map((currencyName) => {
...
const Currentrates = () => {
  ...
  return (
    <main>
      <section className="px-0 sm:px-20 mt-5 sm:mt-10 sm:mb-10 h-auto w-[100%]">
        <div className="mb-4">
          <h2 className="font-bold text-[26px] sm:text-[28px] font-lato leading-tight border-b-[2px] border-gray-300 pb-2">
            Lagos Parallel Rates For USD, EUR & GBP
          </h2>
          <small className="text-[#e93a3a] text-base capitalize font-bold">
              ...
              {getLast5Dates(apiData).map((date) => (
                ...
                >
                  ...
                  {getUniqueCurrencyNames(apiData).map((currencyName) => {
                    ...
                    const rateValue = currencyRate
                      ? currencyRate.currency_rate.split("/")[1].trim()
                      : "N/A";
